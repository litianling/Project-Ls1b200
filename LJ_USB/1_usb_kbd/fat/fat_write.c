...
{
	uint8_t temp_dir_slot_buffer[MAX_LFN_SLOT * sizeof(dir_slot)];
 ...
 */
static int set_fatent_value(fsdata *mydata, uint32_t entry, uint32_t entry_value)
{
 ...
 */
static uint32_t determine_fatent(fsdata *mydata, uint32_t entry)
{
...
static uint8_t tmpbuf_cluster[MAX_CLUSTSIZE] __aligned(ARCH_DMA_MINALIGN);

/*
 * Read and modify data on existing and consecutive cluster blocks
 */
static int
get_set_cluster(fsdata *mydata, uint32_t clustnum, loff_t pos, uint8_t *buffer,
 ...
 */
static int clear_fatent(fsdata *mydata, uint32_t entry)
{
	uint32_t fat_val;
 ...
 */
static int check_overflow(fsdata *mydata, uint32_t clustnum, loff_t size)
{
 ...
 */
static int
set_contents(fsdata *mydata, dir_entry *dentptr, loff_t pos, uint8_t *buffer,
 ...
 * Fill dir_entry
 */
static void fill_dentry(fsdata *mydata, dir_entry *dentptr, const char *filename,
