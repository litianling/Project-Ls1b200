...
-include kernel_samples/subdir.mk
...
OUT_ELF=rt_thread2.exe
OUT_MAP=rt_thread2.map
OUT_BIN=rt_thread2.bin
...
$(OUT_ELF): $(STARTO) $(OBJS) $(USER_OBJS)
	...
	C:/LoongIDE/mips-2015.05/bin/mips-sde-elf-gcc.exe  -mips32 -G0 -EL -msoft-float -nostartfiles -static -T $(LINKCMDS) -o $(OUT_ELF) -e start $(STARTO) $(OBJS) $(USER_OBJS) $(LIBS) 
	@echo 'Invoking: SDE Lite C Objcopy'
	C:/LoongIDE/mips-2015.05/bin/mips-sde-elf-objcopy.exe -O binary $(OUT_ELF) $(OUT_BIN)
	@echo 'Invoking: SDE Lite C Size'
	C:/LoongIDE/mips-2015.05/bin/mips-sde-elf-size.exe $(OUT_ELF)
