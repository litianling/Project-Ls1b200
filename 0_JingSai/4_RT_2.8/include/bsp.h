...
#define Air_Q  44   // 双路信号输出（模拟量输出浓度越高电压越高、TTL输出浓度大于设定浓度输出低电平），5V
#define SG180  43   // 舵机周期20ms 高电平1ms-2ms,3.5V-6V
#define BUZZER 47   // 高电平触发 5V
#define MAN_S  42   // 触发后高电平保持一段时间 4.5V-20V
#define TOUCH  45   // 触发后输出高电平 2V-5V
#define TEMPE  46   // 双向温度数据，3V-5.5V
//#define LTL_DEBUG
#define GUI_SOC 1
#endif // _BSP_H
