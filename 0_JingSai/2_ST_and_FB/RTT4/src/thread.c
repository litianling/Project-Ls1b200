 ...
 * and stack.
 *
 * @param name the name of thread, which shall be unique            线程名字
 * @param entry the entry function of thread                        入口函数
 * @param parameter the parameter of thread enter function          参数
 * @param stack_size the size of thread stack                       堆栈大小
 * @param priority the priority of thread                           优先级
