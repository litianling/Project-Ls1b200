...
#define BUZZER 46   // 高电平触发 5V
#define TOUCH  47   // 触发后输出高电平 2V-5V
#define MAN_S  36   // 触发后高电平保持一段时间 4.5V-20V
#define SG180  32   // 舵机周期20ms 高电平1ms-2ms,3.5V-6V
#define TEMPE  45   // 双向温度数据，3V-5.5V
#define Air_Q  33   // 双路信号输出（模拟量输出浓度越高电压越高、TTL输出浓度大于设定浓度输出低电平），5V
