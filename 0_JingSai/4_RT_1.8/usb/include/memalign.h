...
#define __ALIGNED_DMA(x) __attribute__((aligned(ALIGN(x, ARCH_DMA_MINALIGN))))
...
{
    return aligned_malloc(ALIGN(size, ARCH_DMA_MINALIGN), ARCH_DMA_MINALIGN);
}
